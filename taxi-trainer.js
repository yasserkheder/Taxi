...
function bindDelegatedUiActions() {
    ...
    const handler = event => {
        ...
        const editTarget = event.target.closest('[data-edit-lesson-id]');
        if (editTarget) {
            event.preventDefault();
            event.stopPropagation();
...
function showSection(section) {
    ...
    ['homeSection', 'resultsSection', 'helpSection', 'profileSection', 'addSection', 'lessonView', 'editSection', 'examSection', 'challengeSection', 'assessmentSection'].forEach(id => {
